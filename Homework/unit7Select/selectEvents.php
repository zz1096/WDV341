...
try {
    ...
    $sql = "SELECT events_name, events_description, DATE_FORMAT(events_date, '%M %e, %Y') AS events_dateFormat, DATE_FORMAT(events_time, '%h:%i %p') AS events_timeFormat, events_presenter, events_date_inserted, events_date_updated  FROM wdv341_events";
...
<body>
    ...
    <h2 class="center">UNIT 7 - Select Events</h2>
    <?php
